            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="<?= base_url('arsip/add') ?>" class="btn btn-primary btn-xm btn-flat"> <i  class="fas fa-plus"></i>Tambah Data
                </a>
                </div>
                <!-- /.card-tools -->
              </div>
                        ...
                        <?php $no = 1;
                         foreach ($arsip as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                <a  href="<?= base_url('arsip/edit/'.$value['id_arsip']) ?>" class="btn btn-warning btn-sm btn-flat"><i class="fas fa-pencil-alt"></i></a>
