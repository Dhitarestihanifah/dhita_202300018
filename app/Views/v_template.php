...
<head>
  ...
  <title>Sistem Informasi E-Arsip</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?= base_url('AdminLTE') ?>" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span  href="<?= base_url('Admin') ?>"><b>Arsip</b>Produk Hukum dan Monografi</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu == 'masterdata'? 'menu-open' : '' ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('Arsip')?>" class="nav-link <?= $submenu == 'arsip'? 'active' : '' ?>">
              ...
              <li class="nav-item">
                <a href="<?= base_url('Bagian')?>" class="nav-link <?= $submenu == 'bagian'? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bagian</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022 <a href="">Sistem Informasi E Arsip</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
